...
class ChambreController extends AbstractController
{
    ...
    /**
     * @Route("/{numero}", name="chambre_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{numero}/edit", name="chambre_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{numero}", name="chambre_delete", methods={"DELETE"})
     */
    public function delete(Request $request, Chambre $chambre): Response
    {
        if ($this->isCsrfTokenValid('delete'.$chambre->getNumero(), $request->request->get('_token'))) {
            $entityManager = $this->getDoctrine()->getManager();
